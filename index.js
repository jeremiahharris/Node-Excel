...
exports.execute = function(config){
	...
	var sheetBack = '<x:printOptions gridLines="1" /><x:pageMargins left="0.7" right="0.7" top="0.8" bottom="0.75" header="0.3" footer="0.3" /><x:pageSetup orientation="landscape" fitToHeight="0" />';
	if (config.header)
		sheetBack += '<x:headerFooter scaleWithDoc="0"><x:oddHeader sz="8">' + config.header + '</x:oddHeader></x:headerFooter><x:tableParts count="0" /></x:worksheet>';
	else
