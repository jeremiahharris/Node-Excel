...
var sheetBack = '<x:printOptions gridLines="1" /><x:pageMargins left="0.75" right="0.75" top="0.75" bottom="0.5" header="0.5" footer="0.75" /><pageSetup r:id="rId1" orientation="landscape" scale="61"/><x:headerFooter /><x:tableParts count="0" /></x:worksheet>';
