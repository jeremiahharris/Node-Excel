...
var sheetBack = '<x:printOptions gridLines="1" /><x:pageMargins left="0.75" right="0.75" top="0.75" bottom="0.5" header="0.5" footer="0.75" /><x:pageSetup orientation="landscape" fitToHeight="0" /><x:headerFooter /><x:tableParts count="0" /></x:worksheet>';
