...
var sheetBack = '<x:Print><x:GridLines /></x:Print><x:pageMargins left="0.75" right="0.75" top="0.75" bottom="0.5" header="0.5" footer="0.75" /><x:pageSetup x:orientation="landscape" /><x:headerFooter /><x:tableParts count="0" /></x:worksheet>';
